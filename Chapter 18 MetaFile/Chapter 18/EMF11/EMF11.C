...
void DrawRuler(HDC hdc, int cx, int cy)
{
	...
	//Rectangle surrounding entire pen(withd adjustment)
	...
	//Create logical font
	FillMemory(&lf, sizeof(lf), 0);//½«lfÌî³äÎª0
	lf.lfHeight= cy/2;
...
void CreateRoutine(HWND hwnd)
{
	...
	hdcEMF= CreateEnhMetaFile(NULL, TEXT("emf11.emf"), NULL, TEXT ("EMF11\0EMF Demo #11\0")) ;
...
void PaintRoutine(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
	...
	cxImage= cxImage* cxPix/ cyMms/ 100;
