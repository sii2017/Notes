...
sysmetrics[]=
{
	...
	SM_CXVSCROLL, TEXT("SM_CXVSCROLL"), TEXT("Vetrical scroll width"),
	...
	SM_SWAPBUTTON, TEXT("SM_SWAPBUTTON"), TEXT("Mouse buttons swapped falg"),
	...
	SM_CYSIZEFRAME, TEXT("SM_CYSIZEFREAM"), TEXT("Window sizing frame height"),
	SM_CXMINTRACK, TEXT("SM_CXMINTRACK"), TEXT("Minimun window tracking width"),
	SM_CYMINTRACK, TEXT("SM_CYMINTRACK"), TEXT("Minimun window tracking height"),
	...
	SM_CXMINSPACING, TEXT("SM_CXMINSPACING"), TEXT("Minimized window spacing"),
	SM_CYMINSPACING, TEXT("SM_CYMINSPACING"), TEXT("Minimized window spacing"),
	...
	SM_CXSMSIZE, TEXT("SM_CXSMSIZE"), TEXT("Small caption butthon width"),
	...
	SM_ARRANGE, TEXT("SM_ARRANGE"), TEXT("How minimized windows arrange"),
	...
	SM_CXMAXTRACK, TEXT("SM_CXMAXTRACK"), TEXT("Maximum draggable widht"),
	SM_CYMAXTRACK, TEXT("SM_CYMAXTRACK"), TEXT("Maximun draggable height"),
	...
	SM_MIDEASTENABLED, TEXT("SM_MIDEASTENABLED"), TEXT("Hebrew and arabic enabled"),
