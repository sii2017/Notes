...
BOOL PopFileRead(HWND hwndEdit, PTSTR pstrFileName)
{
	...
	//Text to see if the text is Unicode
	...
	if(IsTextUnicode(pBuffer, iFileLength, &iUniTest))
	{
		...
		//If the edit control is not Unicode, convert Unicode text to non-Unicode
#ifdef UNICODE
...
BOOL PopFileWrite(HWND hwndEdit, PTSTR pstrFileName)
{
	...
	//Get number of characters in the edit control and allocate memory for them
