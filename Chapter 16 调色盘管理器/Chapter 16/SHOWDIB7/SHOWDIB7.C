...
这个版本获取位图信息后，首先转成了DDB，然后创建调色盘在静态变量里，最后释放了packed DIB
*/
#include <windows.h>
#include "PackeDib.h"
#include "resource.h"
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	hwnd= CreateWindow(szAppName, TEXT("Show DIB #7: Converted to DDB"), WS_OVERLAPPEDWINDOW,
