/*
这些函数在后面的程序中都有用，需要复制过去
*/
#include <windows.h>

//将DIB文件去头放入pbmi作为packed DIB
...
//PackedDibGetBitsSize can be calculated from the height and row lenght
//if it is not explicitly in the biSizeImage field
...
HPALETTE PackedDibCreatePalette(BITMAPINFO* pPackedDib)
{
	...
	plp->palVersion= 0x0300;//支持windows3.0
