...
{
	static TCHAR szAppName[]= TEXT("SYSMETSC");
	HWND hwnd;
	MSG msg;
	WNDCLASS wndclass;
	...
	hwnd= CreateWindow(szAppName, TEXT("Get System Metrics NO.4"), WS_OVERLAPPEDWINDOW|
...
/* 总结
WM_CREATE中， 通过tm获得字符的行高，间距
WM_SIZE中，通过wParam获得cx/cyClient，并且设置si（scrollinfo）
WM_VSCROLL,HSCROLL中通过对wParam的flag处理，调整pos的位置，并且scrollwindow并且updatewindows
WM_KEYDOWN中，通过处理wParam，然后转换成发送消息给VSCROLL和HSCROLL
WM_PAINT中，根据pos来设置paint的begin和end，然后输出，具体逻辑没看懂，但是大致意思如此
*/